...
pub struct RqbitDesktopConfigConnections {
    ...
    #[serde_as(as = "serde_with::DurationSeconds")]
    pub peer_read_write_timeout:std::time:: Duration,
}

impl RqbitDesktopConfigConnections {
    pub fn as_listener_and_connect_opts(&self) -> (Option<ListenerOptions>, librqbit::ConnectionOptions) {
...
impl RqbitDesktopConfigPersistence {
    pub fn fix_backwards_compat(&mut self) {
